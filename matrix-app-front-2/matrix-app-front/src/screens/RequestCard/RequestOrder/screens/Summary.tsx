...
export const SumaryScreen = (props: NavigationPropsType) => {
  const {
    route: { params },
    navigation,
  } = props;
    ...
    <ThemeProvider theme={rebrandingTheme}>
      <Container imageBackground={BackgroundNew} isHeaderVisible={false}>
        ...
        >
          <Box>
            <Box alignItems="center">
              ...
              <Text variant="H3" mt="spacing-sm">
                {i18n.t('request-card.sumary.title')}
              </Text>
              <Text my="spacing-s" variant="body13pxRegular" textAlign="center">
                {i18n.t('request-card.sumary.description')}
              </Text>
            </Box>
            <Box
              mx="spacing-none"
            ...
            >
              <Text mb="spacing-xxs" variant="Subtitle16Semibold">
                {i18n.t('request-card.sumary.subTitleUserData')}
              </Text>
              ...
              <Box flexDirection="row" alignItems="center" my="spacing-xxxs" pr="spacing-s">
                ...
                <Box paddingHorizontal="spacing-xxs">
                  ...
                  <Text numberOfLines={2} variant="body14Regular">
                    {`${Helpers.formatStringCamel(address.department.description)}, ${Helpers.formatStringCamel(address.province.description)}, ${Helpers.formatStringCamel(address.district.description)}`}
                  </Text>
                </Box>
              </Box>
              ...
              <Text mt="spacing-sm" variant="Subtitle16Semibold" mb="spacing-xxs">
                {i18n.t('request-card.sumary.subTitleSchedule')}
              </Text>
              <Box flexDirection="row" alignItems="center" my="spacing-xxxs">
          ...
          <Box>
            <Button variant="primary" onPress={goTo} label={i18n.t('request-card.sumary.submit')} />
          </Box>
        </Box>
      </Container>
    </ThemeProvider>
