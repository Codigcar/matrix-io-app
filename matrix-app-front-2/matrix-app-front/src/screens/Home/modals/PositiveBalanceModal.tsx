...
import { Box, Button, Text, rebrandingTheme } from 'matrix-ui-components';
        ...
        >
          <Box flex={1} p="spacing-m">
            ...
            <Text
              ...
              color="primary1000"
            >
              {i18n.t('cancelAccount.modal-positive-bal.title-card')}
            </Text>
            <Box
            ...
            >
              <Box flexDirection="row" mr="spacing-l">
                ...
                <Text ml="spacing-s" variant="body" color="primary800">
                  {i18n.t('cancelAccount.modal-positive-bal.subtitle-card')}
                </Text>
            ...
            <Button
              ...
              label={i18n.t('cancelAccount.modal-positive-bal.button')}
