...
import { setAccumulatedCashback } from 'src/screens/CashBack/states/redemptionState';
  ...
  return (
    <>
      ...
      <Text variant="smallLabelCard" color="primary800">
        {i18n.t('home:cashback.accumulated')}
      </Text>
    </>
  );
};
...
const CashbackScreen: React.FC<CashbackPresenterProps> = (props) => {
  ...
  return (
    <HomeCardWrapper
      ...
      color={!disabled && !isCashbackDelinquentDisabled ? 'complementaryIndigo100' : 'primary100'}
    >
      <CashbackContent
        loading={loading}
