...
import IObtainCashbackRules from 'src/core/modules/cashback/dtos/obtain-rules';
import { useDispatch } from 'react-redux';
import { setRules, setAccount } from 'src/screens/CashBack/states/redemptionState';
