...
export const SignInScreen: React.FC<NavigationPropsType> = (props) => {
  ...
  const { updateVerifyEmailModal, updateMysteryBoxModal } = useContext(ModalContext);
  ...
  return (
    <>
      <BackgroundWrapper>
        ...
        >
          <KeyboardAvoidingBox mt="spacing-none" behavior={ios ? 'padding' : undefined}>
            <Form
              initialValues={{
                dni: identitySaved || '',
                passwordLogin: '',
                ...
                <Box flex={1} justifyContent="center" width="100%">
                  ...
                  <Animated.View style={{ opacity: slideForm }}>
                    <Box mx="spacing-sm">
                      ...
                      <Box paddingHorizontal="spacing-xxxxxs">
                        <Button
