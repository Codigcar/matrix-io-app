...
export const usePasswordPresenter = (
  props: CompositeScreenProps<
    NativeStackScreenProps<ReactNavigation.AuthNavigator, SignUpRoutesEnum.PASSWORD_VERIFICATION>,
  ...
  const onPressContinue = ({ password }: { password: string }) => {
    ...
    navigation.navigate(SignUpRoutesEnum.PASSWORD_REPEAT, { email, documentNumber, password });
  };
