...
import ScreenChat from '../screens/Chat/chat';
...
const tabBarIcon = ({ label, iconName, hasAlert }: Partial<TabBarButtonProps>) =>
    ...
    <Box flex={1} backgroundColor="transparent">
      ...
      >
        ...
        <Tab.Screen
          ...
          listeners={{
            tabPress: () => tabPressWrapper(i18n.t('menu.chat')),
          }}
          options={{
            tabBarStyle: { display: 'none' },
            tabBarLabel: i18n.t('menu.chat'),
            tabBarIcon: tabBarIcon({ label: i18n.t('menu.chat'), iconName: 'chat' }),
            unmountOnBlur: true,
          }}
        />
      </Tab.Navigator>
