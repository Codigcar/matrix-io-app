...
import ChatFilled from 'assets/svgs/headphone.svg';
import ChatOutlined from 'assets/svgs/headphone.svg';
...
import FIllInfoCircle from 'assets/svgs/info-circle-fill.svg';
  ...
  return (
    <ThemeProvider theme={rebrandingTheme}>
      <Box flex={1} alignItems="center" justifyContent="center">
        {Boolean(hasAlert || analyticsAlert) && (
          <Box position="absolute" top={10} zIndex={1} paddingLeft="spacing-xs">
            {analyticsAlert ? <FIllInfoCircle /> : <InfoCircleAlert /> }
          </Box>
        )}
        <Icon />
