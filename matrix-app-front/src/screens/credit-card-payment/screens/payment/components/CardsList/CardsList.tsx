...
import MethodPaymentSkeleton from '../Skeletons/MethodPaymentSkeleton/MethodPaymentSkeleton';
import { CardsListProps, FlatListEventProps } from '../../../../shared/types';
...
const CardsList: React.FC<CardsListProps> = ({
  ...
  const renderAddCardsButton = () => {
    ...
    return (
      <TouchableOpacity onPress={() => navigate()} disabled={!enabled}>
  ...
  return (
    <Box mb="spacing-m" testID="card-list">
      <Box
        flexDirection="row"
      ...
      />
      <LoadingIndicator isVisible={isLoadingDelete} />
    </Box>
  );
};
