...
const CardDocumentDetail = (props: Props) => {
  ...
  const { onDownloadDocument } = useCardDocuments();
  ...
  return (
    <ThemeProvider theme={rebrandingTheme}>
      ...
      <Box flex={1}>
        ...
        >
          <Box position="absolute" left={RFValue(15)} zIndex={2} testID={testID.backArrowBoxId}>
          ...
          {showShareIcon ? (
            <Box position="absolute" right={RFValue(15)} zIndex={2} testID={testID.shareIconBoxId}>
