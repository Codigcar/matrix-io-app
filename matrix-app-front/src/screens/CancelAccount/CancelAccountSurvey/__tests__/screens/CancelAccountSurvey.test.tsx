import { render, renderHook, act, waitFor } from 'jest/test-utils';
...
import { string } from 'src/screens/CancelAccount/shared/strings/string';
...
describe('CancelAccountSurvey Screen', () => {
  it('should render CancelAccountSurvey screen', async () => {
  ...
  it('should execute goToGenericError correctly', async () => {
    const { result } = renderHook(() => useCancelAccountSurvey(ComponentRenderProps), {
      wrapper: ({ children }) => <Provider store={store}>{children}</Provider>,
    });
  ...
  it('should execute onPressBackArrow correctly', async () => {
    const { result } = renderHook(() => useCancelAccountSurvey(ComponentRenderProps), {
      wrapper: ({ children }) => <Provider store={store}>{children}</Provider>,
    });
