...
const useMTXVerifyOTP = (props: NavigationPropsType) => {
  ...
  const onPressSupport = () => {
    navigation.navigate(navigationScreenNames.SupportHome);
  };
  ...
  const formatPhoneNumber = (number: string) => [number.slice(0, 3), number.slice(3, 6), number.slice(6, 9), number.slice(9)].join(' ');
