...
import { Camera, TakePhotoOptions, useCameraDevices } from 'react-native-vision-camera';
import { useIsFocused } from '@react-navigation/native';
import ImageEditor from '@react-native-community/image-editor';
import { DocumentFront } from 'assets/images';
...
const GetDocumentFront = (props: NavigationPropsType) => {
  ...
  if (!device) {
    logCrashlytics({
      scope: 'SDK',
      fileName: 'screens/KYC/DocumentValidation/GetDocumentFront/GetDocumentFront.tsx',
    ...
    <ThemeProvider theme={rebrandingTheme}>
      ...
      >
        ...
        <Box height={RFValue(140)} alignItems="center" maxWidth={RFValue(200)}>
          <Box mt="spacing-m">
            <Chip label={i18n.t('kyc-document-validation-get-front-first-step-title')} />
          </Box>
          <Text mt="spacing-m" variant="Heading" color="white" textAlign="center">
            {i18n.t('kyc-document-validation-get-front-title')}
          </Text>
        </Box>

        <DocumentOpacity image={DocumentFront} cameraReady={cameraReady} />
...
export default GetDocumentFront;
