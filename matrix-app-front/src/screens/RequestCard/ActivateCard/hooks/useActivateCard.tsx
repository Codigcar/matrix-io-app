...
const useActivateCard = (props: NavigationPropsType) => {
  ...
  const goToGenericError = () =>
    navigation.navigate(navigationScreenNames.genericError, {
      title: string.activateCardResponseErrorTitle,
      subtitle: string.activateCardResponseErrorSubtitle,
      text: string.activateCardResponseErrorDescription,
      buttonLabel: string.activateCardResponseErrorButtonLabel,
    });
