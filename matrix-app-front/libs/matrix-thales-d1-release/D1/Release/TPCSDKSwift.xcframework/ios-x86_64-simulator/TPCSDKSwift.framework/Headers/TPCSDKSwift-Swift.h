...
/// Returns directly from <code>PKPaymentAuthorizationViewController.canMakePayments</code>
  SdkConfigureResultFail = 1,
/// SDK configuration failed due to serverHostName or issuerId is null or empty
...
///                      completion:^(NSString * _Nullable primaryAccountIdentifier, enum IsCardDigitizedResult digitizeResult) {
///     switch(digitizeResult) {
...
/// \param primaryAccountIdentifier Primary Account Identifier of the payment card
///
/// \param primaryAccountNumberSuffix The last four or five digits of the card’s number. This field is only used for AMEX scheme and supported only on iOS 13.4 and above.
///
/// \param digitizeResult See <code>IsCardDigitizedResult</code>
///
+ (void)isCardDigitizedWithCard:(FundingCard * _Nullable)card primaryAccountIdentifier:(NSString * _Nullable)primaryAccountIdentifier primaryAccountNumberSuffix:(NSString * _Nullable)primaryAccountNumberSuffix completion:(void (^ _Nonnull)(NSString * _Nullable, enum IsCardDigitizedResult))completion;
...
///    // TODO: Use primaryAccountIdentifier
/// }
///
/// \endcode\code
...
///
+ (void)getCardDigitizationResultWithCard:(FundingCard * _Nullable)card primaryAccountIdentifier:(NSString * _Nullable)primaryAccountIdentifier primaryAccountNumberSuffix:(NSString * _Nullable)primaryAccountNumberSuffix completion:(void (^ _Nonnull)(NSString * _Nullable, CardDigitizationResult * _Nonnull))completion;
...
///
/// \param primaryAccountIdentifier An FPANID for the card. If not pass, the SDK will retrieved it from the server
///
/// \param provisionDelegate See <code>TPCSDKProvisionDelegate</code>
///
...
///
/// \param pendingActivationPass See <code>PendingActivationPass</code>. Will return nil when one of the following condition is match:
/// <ol>
///   <li>
///     <code>issuerId</code> from config is null or empty
///   </li>
...
///
/// \param error Description of the error. Returns directly from <code>PKPassLibrary.activate</code>
///
...
/// note:
/// For iOS 13.4+, use TPCSDK.getSecureElementPaymentPasses instead
+ (void)getPaymentPassesWithCompletion:(void (^ _Nonnull)(NSArray<PKPass *> * _Nullable, NSArray<PKPaymentPass *> * _Nullable))completion;
/// Get Secure Element Payment Passes from PKPassLibrary for iOS 13.4 and above.
/// note:
/// For iOS 13.4+, the  app checks existing passes with passes() and remoteSecureElementPasses
+ (void)getSecureElementPaymentPassesWithCompletion:(void (^ _Nonnull)(NSArray<PKPass *> * _Nullable, NSArray<PKSecureElementPass *> * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=13.4);
...
/// \param success Result from update token state
///
+ (void)updateTokenStateWithTokenId:(NSString * _Nonnull)tokenId tokenRequestorId:(NSString * _Nonnull)tokenRequestorId schemeString:(NSString * _Nonnull)schemeString authorizationCode:(NSString * _Nonnull)authorizationCode action:(enum TokenState)action completion:(void (^ _Nonnull)(BOOL))completion;
/// Get cards
/// \code
...
///                            kyc:kyc
///                           size:size
///                     completion:^(CardAsset * _Nullable cardAsset) {
/// }];
///
...
///
+ (void)getCardAssetWithCardId:(NSString * _Nonnull)cardId kyc:(NSString * _Nonnull)kyc size:(enum CardAssetSize)size completion:(void (^ _Nonnull)(CardAsset * _Nullable))completion;
...
///
/// \param error This error could be return when one of the following condition is match:
/// <ol>
///   <li>
///     <code>issuerId</code> from config is null or empty
///   </li>
...
///   </li>
///   <li>
///     Any other that is returned from Apple Pay API. Please check the details here https://developer.apple.com/documentation/passkit/pkaddpaymentpassviewcontrollerdelegate/1615942-addpaymentpassviewcontroller
///   </li>
/// </ol>
///
